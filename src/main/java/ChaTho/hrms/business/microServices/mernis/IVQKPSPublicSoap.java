...
public class IVQKPSPublicSoap
{
    ...
    public IVQKPSPublicSoap(){}

    public IVQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IVQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IVQExtendedSoapSerializationEnvelope envelope= new IVQExtendedSoapSerializationEnvelope(IVQExtendedSoapSerializationEnvelope.VER11);
