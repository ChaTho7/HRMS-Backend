...
public class IVQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IVQDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IVQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IVQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IVQDateTimeConverter dateTimeConverter = new IVQStandardDateTimeConverter();

    public IVQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IVQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IVQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IVQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IVQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IVQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
